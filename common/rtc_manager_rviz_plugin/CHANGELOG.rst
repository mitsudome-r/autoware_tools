...
* feat(rtc_manager_panel): add cooperateStatus state column (`#104 <https://github.com/autowarefoundation/autoware_tools/issues/104>`_)
  * add another column
  * fix
  ---------
...
* Contributors: Go Sakayori, Mamoru Sobue, Satoshi OTA, awf-autoware-bot[bot]

...
0.3.1 (2025-11-16)
------------------
* feat(autoware_localization_evaluation_scripts): add new diagnostics to check and refactor diagnostics_flag_check (`#310 <https://github.com/mitsudome-r/autoware_tools/issues/310>`_)
...
* chore: update maintainer (`#304 <https://github.com/mitsudome-r/autoware_tools/issues/304>`_)
  ...
  * chore: update maintainer
  ...
  ---------
* fix(autoware_localization_evaluation_scripts): fix diagnostics flag check expection handling (`#303 <https://github.com/mitsudome-r/autoware_tools/issues/303>`_)
  * fix process when there is no DiagnosticsFlagCheck in scenario
  * fix typo
  ---------
* feat(autoware_localization_evaluation_scripts): detect rise/fall flags of localization diagnostics (`#298 <https://github.com/mitsudome-r/autoware_tools/issues/298>`_)
  ...
  * fix docs mistake
  ---------
* feat(autoware_localization_evaluation_scripts): create masks for each criterion (`#297 <https://github.com/mitsudome-r/autoware_tools/issues/297>`_)
